...
## About Capstone
Capstone is the largest undertaking while at Ada Developers Academy. Given roughly 3 weeks, students will be both the product owner and developer. It is up to students to decide what and how things get built, given the challenge of incorporating at least 3 new learned technologies. For additional information on Ada Capstone, vist project repo [here](https://github.com/Ada-C12/capstone).
